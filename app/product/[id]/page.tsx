...
export default function ProductPage() {
    ...
    return (
        <main className="min-h-screen bg-background text-foreground transition-colors duration-300">
                    ...
                    <div className="flex flex-col lg:flex-row gap-12">
                                ...
                                <div className="flex gap-3">
                                    {product.images.map((img, index) => (
                                        <button
                                            ...
                                            className={`relative w-20 h-20 rounded-xl overflow-hidden border-2 transition-all bg-white ${selectedImage === index
                        ...
                        <div className="lg:w-1/2 space-y-6">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-blue-600 font-bold">{product.bought} bought this month</span>
                            </div>
                            ...
                            <div className="flex gap-4 pt-4">
                                ...
                                <button
                                    onClick={() => setIsWishlisted(!isWishlisted)}
                                    className={`py-4 px-6 rounded-2xl font-brand font-bold uppercase text-sm border-2 flex items-center justify-center gap-2 transition-all ${isWishlisted
                            ...
                            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-card-border">
                                <div className="text-center">
                                    <div className="w-12 h-12 bg-card-bg border border-card-border rounded-full flex items-center justify-center mx-auto mb-2 shadow-sm">
                                        <Truck size={20} className="text-blue-600" />
                                    </div>
                                    <p className="text-xs text-stone-500 font-medium">Free Shipping<br />above ₹499</p>
                                </div>
                                <div className="text-center">
                                    <div className="w-12 h-12 bg-card-bg border border-card-border rounded-full flex items-center justify-center mx-auto mb-2 shadow-sm">
                                        <Shield size={20} className="text-green-600" />
                                    </div>
                                    <p className="text-xs text-stone-500 font-medium">100% Authentic<br />Products</p>
                                </div>
                                <div className="text-center">
                                    <div className="w-12 h-12 bg-card-bg border border-card-border rounded-full flex items-center justify-center mx-auto mb-2 shadow-sm">
                                        <RotateCcw size={20} className="text-lava-orange" />
                                    </div>
                                    <p className="text-xs text-stone-500 font-medium">Easy Returns<br />in 7 Days</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* Mobile Sticky CTA */}
            <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-card-bg border-t border-card-border p-4 z-50 flex gap-3 shadow-lg">
                <button
                    onClick={() => setIsWishlisted(!isWishlisted)}
                    className="w-14 h-14 border border-card-border rounded-xl flex items-center justify-center"
                >
                    <Heart size={24} className={isWishlisted ? 'fill-berry-pink text-berry-pink' : 'text-foreground'} />
                </button>
                <button
                    onClick={handleAddToCart}
                    className={`flex-1 py-4 rounded-xl font-brand font-black uppercase flex items-center justify-center gap-2 transition-all ${addedToCart
                        ? 'bg-green-600 text-white'
